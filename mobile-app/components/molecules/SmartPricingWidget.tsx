    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.confidenceBadge}>
          ...
          <Text variant="caption" color="secondary" style={styles.confidenceText}>
      ...
      <View style={styles.priceSection}>
        ...
        <Text variant="bodyMedium" color="secondary" style={styles.priceRange}>
      ...
      <View style={styles.insightsSection}>
        ...
        <View style={styles.insightRow}>
          ...
          <View style={styles.insightValueContainer}>
            ...
            <Text variant="labelLarge" style={[styles.insightValue, { color: competitiveColor }]}>
        ...
        <View style={styles.insightRow}>
          ...
          <Text variant="labelLarge" style={styles.insightValue}>
      ...
      <View style={styles.earningsSection}>
        ...
        <Text variant="caption" color="secondary" style={styles.earningsNote}>
      ...
      <View style={styles.discountsSection}>
        ...
        <View style={styles.discountRow}>
          ...
          <Text variant="labelLarge" style={styles.discountValue}>
